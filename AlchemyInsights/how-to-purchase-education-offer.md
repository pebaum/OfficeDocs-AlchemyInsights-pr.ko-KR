...
3. 구입 하려는 평가판에서 **지금 구입** 을 선택 합니다. 
    
평가판이 아닌 다른 구독을 구매 하려면 [서비스 구매](https://go.microsoft.com/fwlink/p/?linkid=868433) 페이지로 이동 하거나, **결제** \> **구매 서비스**를 선택한 다음, **교육 계획**아래의 목록에서 선택 합니다.
