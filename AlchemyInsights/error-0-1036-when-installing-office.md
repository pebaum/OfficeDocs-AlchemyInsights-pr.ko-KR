...
ms.locfileid: "29900510"
---
# <a name="error-0-1036-when-installing-office"></a>0-1036 office를 설치 하는 경우 오류


0-1036 하 여 Office 오류를 해결 하려면 이러한 솔루션을 시도 합니다.
  
- 컴퓨터를 다시 시작 하 고 [Office를 설치](https://portal.office.com/OLS/MySoftware.aspx) 를 다시 시도 합니다. 
    
- 다운로드 하 고는 [지원 및 복구 도우미](https://aka.ms/SARA-OfficeUninstall-Alchemy)를 설치 합니다.
    
1. 열릴 때 **제거 Office 제품** 에서 제거 하려는 버전을 선택 하 고 **** 을 선택 합니다.
