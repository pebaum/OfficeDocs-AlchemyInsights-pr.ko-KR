...
4. **별칭** 상자에 새 전자 메일을 입력 한 다음 **추가**선택 합니다. GoDaddy 또는 다른 파트너 로부터 구독을 구입한 경우의 기본으로 새 별칭을 설정 하려면 GoDaddy/파트너 관리 콘솔으로 이동 해야 있습니다. 
    ...
    **에 대 한 자세한 내용은이 문서를 참조:** [사용자에 대 한 추가 추가 전자 메일 별칭](https://support.office.com/article/https://support.office.com/en-US/article/Add-additional-email-aliases-to-a-user-0b0bd900-68b1-4bf5-808b-5d240a7739f4.aspx)
