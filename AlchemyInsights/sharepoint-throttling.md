...
ms.locfileid: "34758351"
---
# <a name="sharepoint-online-throttling"></a>SharePoint Online 제한

SharePoint Online에서는 제한 기능을 사용 하 여 SharePoint Online 서비스의 최적의 성능과 안정성을 유지 관리 합니다. 제한은 리소스를 과도 하 게 사용 하지 못하도록 사용자 작업 수 또는 스크립트 또는 코드에의 한 동시 통화를 제한 합니다. 자세한 내용을 보려면 아래 링크를 방문 하세요.
