...
컴퓨터에서 Office 365 ProPlus를 제거 하려고 하면 다음과 같은 오류 메시지가 나타날 수 있습니다.
  
> "인가 잘못 된 30016 4"
    
이 문제는 **%temp%** 드라이브 **% ProgramFiles %** 가 아닌 다른 드라이브에 매핑되는 경우에 발생 합니다. 
  
문제를 해결 하 고, 하려면 컴퓨터에서 Office 완전히 제거 합니다.
  
1. 다운로드 하 고는 [지원 및 복구 도우미](https://aka.ms/SARA-OfficeUninstall-Alchemy)를 설치 합니다.
    
2. 열릴 때 **제거 Office 제품** 에서 제거 하 고 **다음**을 선택 하려면 버전을 선택 합니다. 
