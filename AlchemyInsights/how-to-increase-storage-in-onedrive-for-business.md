...
비즈니스용 OneDrive에서 저장소를 향상 시키려면 **비즈니스용 Onedrive 계획 2** 또는 **Office 365 Enterprise**e 3이 포함 된 Office 365 요금제를 선택 합니다. 
  
요금제를 변경 하려면 Microsoft 365 관리 센터에서 **청구** \> **구독**으로 이동한 다음 **요금제 전환을 선택 합니다.**
  
요금제 및 비즈니스용 OneDrive 저장소를 전환 하는 방법에 대 한 자세한 내용은 [다른 Office 365 for business 요금제](https://go.microsoft.com/fwlink/?LinkId=2031117) 및 [비즈니스용 onedrive 서비스 설명을](https://go.microsoft.com/fwlink/?LinkId-2031122)참조 하세요.
