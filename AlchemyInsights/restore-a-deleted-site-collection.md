...
삭제 된 통신 사이트를 복원 하려면 새 SharePoint 관리 센터를 사용할 수 있습니다. 그렇지 않으면 Microsoft PowerShell을 사용 해야 합니다. Office 365 그룹에 속하는 사이트를 복원 하려면 Exchange 관리 센터에서 그룹을 복원 해야 합니다. 그룹을 삭제 한 후 30 일 동안 복원할 수 있습니다.
