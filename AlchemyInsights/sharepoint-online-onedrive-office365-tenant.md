...
사용자가 기존 테 넌 트에 추가 되 면 프로 비전 프로세스가 완료 될 때까지 SharePoint Online 또는 비즈니스용 OneDrive 아이콘이 "설정" 또는 "계속 해 서 파일을 사용 하 고 있습니다."로 나열 된 것을 볼 수 있습니다. 도움말을 보려면 다음 [문제 해결 가이드](https://docs.microsoft.com/sharepoint/support/sites/troubleshooting-guide-for-sites-stopped-at-provisioning) 를 따르세요.
