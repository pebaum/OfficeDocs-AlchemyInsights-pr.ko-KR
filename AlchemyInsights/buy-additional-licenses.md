...
2. 라이선스를 추가할 구독을 찾은 다음 **라이선스 추가/제거**를 선택 합니다.
    ...
    [추가/제거 링크가 표시 되지 않으면 어떻게 하나요?](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/buy-licenses#what-if-i-dont-see-the-addremove-licenses-link)

3. **총 라이선스** 상자에이 구독에 필요한 총 라이선스 수를 입력 한 다음 * 변경 사항 * *을 선택 합니다** . 예를 들어 100개의 라이선스가 있는데 5개를 더 추가해야 하는 경우 105를 입력합니다.
