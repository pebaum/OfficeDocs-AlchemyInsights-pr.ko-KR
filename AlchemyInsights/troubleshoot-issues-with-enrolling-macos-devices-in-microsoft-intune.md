...
ms.locfileid: "29478702"
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Microsoft Intune에서 macOS 장치 등록 된 문제를 해결
...
3. [Microsoft Intune에서 macOS 장치를 등록 하는 방법에 알아봅니다](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[최종 사용자 가이드를 Microsoft Intune에서 macOS 장치를 등록 하려면](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
