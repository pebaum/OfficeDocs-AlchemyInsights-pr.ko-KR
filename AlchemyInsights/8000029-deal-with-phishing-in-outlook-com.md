...
---
# <a name="deal-with-phishing-scams-in-your-inbox"></a>받은 편지함에 피싱 메일 처리

피싱 사기 처럼 보이는 전자 메일을 가져오는 경우에이 보고할 수 있습니다.
  
1. 메시지를 마우스 오른쪽 단추로 클릭 하 고 **정크 메일로 표시**를 선택 합니다. 
    
2. 정크 메일 폴더로 이동 하 고 메시지를 선택 합니다.
    
3. 페이지의 위쪽 **정크 메일 아님으로** 옆에 있는 화살표를 선택 하 고 **피싱**를 선택 합니다. 
    
[처리 하도록 오용, 피싱, 또는 스푸핑](https://go.microsoft.com/fwlink/p/?linkid=873139)하는 방법에 대해 알아봅니다.
