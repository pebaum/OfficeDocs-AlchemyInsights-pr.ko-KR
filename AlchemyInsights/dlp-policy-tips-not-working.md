...
- 정책 팁의 단계를 사용 하 여 DLP 규칙에서 **사용 하도록 설정** 된 확인 [여기](https://docs.microsoft.com/office365/securitycompliance/use-notifications-and-policy-tips)합니다.
    
- 확인 **일치 하는 콘텐츠** **필요한** 이 문서에 설명 된 규칙을 트리거하기 [여기](https://docs.microsoft.com/office365/securitycompliance/what-the-sensitive-information-types-look-for)합니다.
...
DLP 정책 팁에 대 한 자세한 내용은 참조: [DLP 정책에 대 한 정책 팁을 표시 합니다](https://docs.microsoft.com/office365/securitycompliance/use-notifications-and-policy-tips) .
