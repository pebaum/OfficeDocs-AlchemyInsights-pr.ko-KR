...
- [SharePoint Online 외부 공유 개요](https://docs.microsoft.com/sharepoint/external-sharing-overview)
...
- [Microsoft Teams의 게스트 액세스](https://docs.microsoft.com/microsoftteams/guest-access-checklist)
