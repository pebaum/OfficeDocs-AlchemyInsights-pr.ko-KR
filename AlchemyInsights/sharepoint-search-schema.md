...
검색 스키마를 변경 하 고 관리 속성을 만들고 크롤링 속성을 관리 속성에 매핑하려면 [SharePoint Online에서 검색 스키마 관리](https://docs.microsoft.com/sharepoint/manage-search-schema)를 참조 하세요. 스키마를 변경할 때 ' 응용 프로그램을 일시 중지 했습니다 ' 라는 경고 메시지가 표시 되 면 서비스 유지 관리가 일시적 으로만 발생 합니다. 
