...
ms.locfileid: "43105353"
---
# <a name="schedule-a-meeting-in-teams"></a>팀에서 모임 예약

**중요**: 모임을 만들거나 팀에서 모임 옵션을 찾을 수 없는 경우 영향을 받는 사용자 [에 게 Exchange Online 사서함에 대 한 사용이 허가 되어 있고 사서함이 사용 하도록 설정](https://docs.microsoft.com/exchange/recipients-in-exchange-online/create-user-mailboxes)되어 있는지 확인 합니다.
...
- 모임에 대 한 제한 및 사양에 대해서는 [Microsoft 팀에 대 한 제한 및 사양을](https://docs.microsoft.com/microsoftteams/limits-specifications-teams#meetings-and-calls)참조 하세요.
