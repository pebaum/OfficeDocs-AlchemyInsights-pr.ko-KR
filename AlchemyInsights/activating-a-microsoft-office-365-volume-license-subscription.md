...
6. 로그인 한 후에는 [제품](https://go.microsoft.com/fwlink/p/?linkid=842054) **청구** \> 페이지로 이동 하 여 구매한 구독이 테 넌 트 내에서 활성화 되어 있는지 확인할 수 있습니다. (VLSC에서 **구독** 탭을 선택 하 여 구독이 보관 되었는지 확인 하는 세부 정보를 확인할 수도 있습니다.)
