...
- 조직의 모든 사서함에 대 한 보류를 설정 하려면 [다음 단계를 수행](https://docs.microsoft.com/office365/securitycompliance/retention-policies#applying-a-retention-policy-to-an-entire-organization-or-specific-locations)하 여 Office 365 보존 정책을 사용할 수 있습니다. 조직 전체 보존 정책의 경우 새 사용자가 정책에 자동으로 할당 됩니다.
