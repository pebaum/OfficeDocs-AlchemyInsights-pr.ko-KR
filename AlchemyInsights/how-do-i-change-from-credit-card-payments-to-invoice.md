...
2. 변경할 구독을 선택합니다. **청구** 섹션에서 현재 결제 방법에 대 한 **편집** 옵션을 선택 합니다.

3. **이 구독에 대 한 결제 방법 변경** 상자에서 **변경을**선택 하 고 다른 결제 방법을 선택 하거나 추가한 다음 **저장**을 선택 합니다.

   > [!NOTE]
   > 이 옵션이 표시 되지 않는 경우 구독이 송장 별 청구에 대 한 최소 비용 금액을 충족 하지 않으므로 구독에 대해 신용 카드 또는 은행 계좌에서 송장으로 전환 하는 것을 사용할 수 없습니다. 송장 청구에 필요한 최소 비용 금액은 지역별로 다릅니다.
