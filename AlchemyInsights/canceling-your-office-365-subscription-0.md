...
조직 데이터를 기반으로 모든 현재 구독이 25 명 미만인 것으로 예상 됩니다. 온라인 구독을 취소 하려면 구독 페이지로 이동 하거나 [](https://go.microsoft.com/fwlink/p/?linkid=842054) , **청구** \> **구독**으로 이동한 다음, **기타 작업** \> **취소 구독**을 선택 합니다.
