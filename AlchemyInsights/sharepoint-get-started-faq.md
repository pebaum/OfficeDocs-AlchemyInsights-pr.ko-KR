...
SharePoint를 확인 하는 것 처럼 보입니다. 오류, 사용 중인 기능 등을 포함 하 여 문제를 설명 하는 하나 또는 두 개의 문장으로 질문을 다시 입력 하는 경우 보다 정확한 답을 얻을 수 있습니다. 몇 가지 Faq는 다음과 같습니다.

시작:

사이트 관리 전략을 사용 하 여 [SharePoint Online을 시작](https://docs.microsoft.com/sharepoint/introduction) 하는 방법을 알아봅니다.
...
저장소: 사용자 OneDrive 저장소</a>를 관리 합니다. 구독에 대 한 [사이트 저장소를 관리](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits) 하 고 [모든 제한을 이해](https://docs.microsoft.com/office365/servicedescriptions/sharepoint-online-service-description/sharepoint-online-limits)합니다.
