...
- 메시지 배달이 지연 되는 것을 알 수 있나요? ATP 안전한 첨부 파일 정책에서 [동적 배달](https://docs.microsoft.com/office365/securitycompliance/dynamic-delivery-and-previewing) 옵션을 사용 합니다. 이를 통해 악성 파일에서 받는 사람을 보호 하는 동안 메시지 지연을 방지할 수 있습니다.
