...
새 동기화 클라이언트를 사용하는 대신에 탐색기 보기를 사용하도록 선택한 경우 아래 문서의 단계와 모범사례를 수행해야 합니다.
...
참고: 탐색기에서 열기 단추는 새 라이브러리 환경에 표시되지 않습니다. 오른쪽 위의 보기 드롭다운(현재 보기에 따라 드롭다운 이름이 변경됨)을 클릭한 다음, 파일 탐색기에서 보기를 클릭합니다.
