...
---
# <a name="change-the-default-onedrive-storage-space-for-your-users"></a>사용자의 기본 OneDrive 저장소 공간 변경

1. [OneDrive 관리 센터의 저장소 페이지로](https://admin.onedrive.com/?v=StorageSettings)이동 합니다.
    
2. **기본 저장소** 상자에 기본 저장소 크기 (GB)를 입력 하 고 **저장**을 클릭 합니다.
