...
2. [Office 365에서 소프트웨어 다운로드 설정을 관리](https://docs.microsoft.com/DeployOffice/manage-software-download-settings-office-365)합니다.

3. [사용자에 게 라이선스를 할당](https://docs.microsoft.com//office365/admin/subscriptions-and-billing/assign-licenses-to-users)합니다.
