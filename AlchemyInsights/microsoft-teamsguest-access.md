...
먼저 [게스트 액세스 검사 목록의](https://docs.microsoft.com/en-us/microsoftteams/guest-access-checklist)모든 단계를 수행 했는지 확인 합니다. 이러한 모든 단계가 완료 되 면 설정이 적용 되도록 [24 시간까지 기다려야](https://docs.microsoft.com/en-us/microsoftteams/manage-guests#guest-access-latencies) 합니다.
